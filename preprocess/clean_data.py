...
if __name__ == '__main__':
    ...
    X_train_original = X_train_scaled.copy()  # 保存原始数据以便后续输出
    ...
    # 保存清理后的原始数据和标签
    X_train_original_cleaned.to_csv(f'preprocess/{DS_NAME}_cleaned_train_data.csv', index=False)
    y_train_original_cleaned.to_csv(f'preprocess/{DS_NAME}_cleaned_train_labels.csv', index=False)
