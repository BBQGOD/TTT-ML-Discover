...
if DS_TYPE == "dir":
    ...
    X_train_scaled.to_csv(f'preprocess/{DS_NAME}_X_train_wo_scaled.csv', index=False, header=True)
    X_test_scaled.to_csv(f'preprocess/{DS_NAME}_X_test_wo_scaled.csv', index=False, header=True)
